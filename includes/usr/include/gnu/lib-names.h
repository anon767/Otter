...
#define	LIBNSS1_COMPAT_SO	"libnss1_compat.so.1"
#define	LIBNSS1_DB_SO	"libnss1_db.so.1"
#define	LIBNSS1_DNS_SO	"libnss1_dns.so.1"
#define	LIBNSS1_FILES_SO	"libnss1_files.so.1"
#define	LIBNSS1_NIS_SO	"libnss1_nis.so.1"
