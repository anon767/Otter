...
#define PACKAGE_STRING "PostgreSQL 7.4.19"
...
#define PG_VERSION_STR "PostgreSQL 7.4.19 on i686-redhat-linux-gnu, compiled by GCC gcc (GCC) 3.4.6 20060404 (Red Hat 3.4.6-9)"
