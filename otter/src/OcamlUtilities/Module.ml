...
module CombineHashedTypes (T1 : Hashtbl.HashedType) (T2 : Hashtbl.HashedType) (*: Hashtbl.HashedType*) = struct
    type t = T1.t * T2.t
    let hash (t1, t2) = Hashtbl.hash (T1.hash t1, T2.hash t2)
    let equal (t1, t2) (t1', t2') = T1.equal t1 t1' && T2.equal t2 t2'
end

module CombineHashedTypes3 (T1 : Hashtbl.HashedType) (T2 : Hashtbl.HashedType) (T3 : Hashtbl.HashedType) (*: Hashtbl.HashedType*) = struct
