...
void LREM_remove_all_the_occurrences_dash_ziplist(void); void LREM_remove_the_first_occurrence_dash_ziplist(void); void LREM_remove_non_existing_element_dash_ziplist(void);
void LREM_starting_from_tail_with_negative_count_dash_ziplist(void); void LREM_starting_from_tail_with_negative_count_lparen2rparen_dash_ziplist(void);
