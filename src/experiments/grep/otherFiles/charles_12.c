...
void symtest_initialize() {
	...
	sym_file_t* input1 = IOSIM_addfile("/grep/charles_12_1.txt", 0);
	input1->contents = "abc";
	input1->stat.st_size = 3;

	sym_file_t* input2 = IOSIM_addfile("/grep/charles_12_2.txt", 0);
        input2->contents = "123";
        input2->stat.st_size = 3;
}
